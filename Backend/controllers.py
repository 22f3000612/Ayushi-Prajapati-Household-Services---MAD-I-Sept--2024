...
def admin_dashboard():
    ...
    servicerequets=Servicereq.query.all()
    return render_template("admindashboard.html",name=session.get('username'),services=services,customers=customers,professionals=professionals,servicerequets=servicerequets)
